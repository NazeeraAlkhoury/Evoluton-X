...
import 'package:evoluton_x/features/players/presentation/views/result_after_scaning_view.dart';
import 'package:evoluton_x/features/players/presentation/views/scaning_view.dart';
    ...
    switch (settings.name) {
      ...
      case clubCard:
        return MaterialPageRoute(builder: (_) {
          final club = settings.arguments as Club;
          return ClubCardView(
            club: club,
          );
        });
